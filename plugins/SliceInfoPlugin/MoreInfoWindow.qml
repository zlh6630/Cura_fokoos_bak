    ...
    Item
    {
        ...
        Item  // Text part
        {
            ...
            Label
            {
                ...
                text: catalog.i18nc("@text:window", "FOKOOS Slicer collects anonymous data in order to improve the print quality and user experience. Below is an example of all the data that is shared:")
