...
Item
{
    ...
    Label
    {
        ...
        text: catalog.i18nc("@label", "Help us to improve FOKOOS Slicer")
    ...
    Item
    {
        ...
        Column
        {
            ...
            Label
            {
                ...
                anchors.horizontalCenter: parent.horizontalCenter
                horizontalAlignment: Text.AlignHCenter
                text: catalog.i18nc("@text", "FOKOOS Slicer collects anonymous data to improve print quality and user experience, including:")
            ...
            Label
            {
                ...
                text:
                {
                    var t = catalog.i18nc("@text", "Data collected by FOKOOS Slicer will not contain any personal information.")
